...
(decimal, decimal, decimal) Convert(decimal r, decimal g, decimal b) {
	return ((r+1)/256, (g+1)/256, (b+1)/256);
}

var (r, g, b) = Convert(0, 255, 255);
Console.WriteLine($"{r.ToString("0.##").Replace(",", ".")}, {g.ToString("0.##").Replace(",", ".")}, {b.ToString("0.##").Replace(",", ".")}");
